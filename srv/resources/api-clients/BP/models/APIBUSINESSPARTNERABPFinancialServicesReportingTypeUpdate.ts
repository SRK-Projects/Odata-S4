 ...
 * 
 * @export
 * @interface APIBUSINESSPARTNERABPFinancialServicesReportingTypeUpdate
 */
export interface APIBUSINESSPARTNERABPFinancialServicesReportingTypeUpdate {
    /**
     * Non-Resident According to Paragraph 4 AWG
     * @type {boolean}
     * @memberof APIBUSINESSPARTNERABPFinancialServicesReportingTypeUpdate
     */
...
/**
 * Check if a given object implements the APIBUSINESSPARTNERABPFinancialServicesReportingTypeUpdate interface.
 */
export function instanceOfAPIBUSINESSPARTNERABPFinancialServicesReportingTypeUpdate(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function APIBUSINESSPARTNERABPFinancialServicesReportingTypeUpdateFromJSON(json: any): APIBUSINESSPARTNERABPFinancialServicesReportingTypeUpdate {
    return APIBUSINESSPARTNERABPFinancialServicesReportingTypeUpdateFromJSONTyped(json, false);
}

export function APIBUSINESSPARTNERABPFinancialServicesReportingTypeUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): APIBUSINESSPARTNERABPFinancialServicesReportingTypeUpdate {
...
export function APIBUSINESSPARTNERABPFinancialServicesReportingTypeUpdateToJSON(value?: APIBUSINESSPARTNERABPFinancialServicesReportingTypeUpdate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
